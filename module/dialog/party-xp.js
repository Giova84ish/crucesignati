export class CrucesignatiPartyXP extends FormApplication {

    static get defaultOptions() {
        return foundry.utils.mergeObject(super.defaultOptions, {
            classes: ["crucesignati", "dialog", "party-xp"],
            template: "systems/crucesignati/templates/apps/party-xp.html",
            width: 300,
            height: "auto",
            resizable: false,
        });
     ...
     */
    get title() {
        return game.i18n.localize("CRUCESIGNATI.dialog.xp.deal");
    }
     ...
     */
    getData() {
        const actors = this.object.entities.filter(e => e.data.type === "character" && e.data.flags.crucesignati && e.data.flags.crucesignati.party === true);
        let data = {
            actors: actors,
            data: this.object,
